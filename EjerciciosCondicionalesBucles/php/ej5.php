...
echo "<br>";
if(($dado1==$dado2 and $dado1==$dado3 )and ($dado4!=$dado5 or $dado4!=$dado6 or $dado5!=$dado6)){
    echo "<p>Ha ganado el jugador uno</p>";

}elseif(($dado4==$dado5 and $dado4==$dado6 )and ($dado1!=$dado2 or $dado1!=$dado3 or $dado2!=$dado3)) {
    echo "<p>Ha ganado el jugador dos</p>";

}elseif(($dado1==$dado2 and $dado1==$dado3 )and ($dado4==$dado5 and $dado4==$dado6)){
    if($dado1>$dado4){
        echo "<p>Ha ganado el jugador uno</p>";
    }elseif($dado1<$dado4){
        echo "<p>Ha ganado el jugador dos</p>";
...
}elseif (($dado1==$dado2 or $dado1==$dado3 or $dado2==$dado3 )and ($dado4!=$dado5 and $dado4!=$dado6 and $dado5!=$dado6)){
    echo "<p>Ha ganado el jugador uno</p>";
}elseif (($dado1!=$dado2 and $dado1!=$dado3 and $dado2!=$dado3 )and ($dado4==$dado5 or $dado4==$dado6 or $dado5==$dado6)){
    echo "<p>Ha ganado el jugador dos</p>";
}elseif (($dado1==$dado2 or $dado1==$dado3 or $dado2==$dado3 )and ($dado4==$dado5 or $dado4==$dado6 or $dado5==$dado6)){
    if ($dado1==$dado2 or $dado1==$dado3){
        if($dado4==$dado5 or $dado4==$dado6){
            if($dado1>$dado4){
                echo "<p>Ha ganado el jugador uno</p>"; 
            }elseif($dado1<$dado4){
                echo "<p>Ha ganado el jugador dos</p>"; 
